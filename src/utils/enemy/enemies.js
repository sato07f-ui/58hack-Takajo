...
export const ENEMIES = [
  ...
  { id: 'spinach', name: 'ほうれん草', modelUrl: spinachUrl, targetUrl: '/targets/spinach.mind', height: 0.35, dropItemId: 'coin' },
  // 特別な敵: 本物のバナナを YOLO で検出して出す（画像認識では出さないので targetUrl は null）
  { id: 'banana', name: 'バナナ', modelUrl: bananaUrl, targetUrl: null, detectClass: 'banana', height: 0.3, dropItemId: 'coin' },
]
